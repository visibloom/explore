    ...
    return(
        ...
        <div id="about" ref={aboutRef} className="visi-section scroll-m-20">
            <div className="visi-container">
                ...
                <div className="visi-divider fade" style={{background: `url(${placeholder})`}}>Spread the beauty and artistic nature your posts and contents!</div>
                <div className="grid grid-cols-2 gap-4 mt-20 max-sm:grid-cols-1 max-sm:mt-4">
                    ...
                    <div>
                        <img src={placeholder2} className="w-auto rounded-2xl fadeRight" alt="" />
                    </div>
                </div>
                <div className="grid grid-cols-2 gap-4 mt-20 max-sm:grid-cols-1 max-sm:mt-4">
                    <div className="max-sm:order-2">
                        <img src={placeholder2} className="w-auto rounded-2xl fadeLeft" alt="" />
                    </div>
